...
const About = ({ isDarkMode }) => {
  return (
    <motion.div id='about' className='w-full px-[12%] py-10 scroll-mt-20 pt-36'
        initial={{ opacity: 0 }}
        ...
        <motion.h4 className='text-center mb-2 text-lg font-Ovo'
            ...
            transition={{ duration: 1, delay: 0.1 }}>Introduction</motion.h4>
        ...
        <motion.div 
            ...
            <motion.div 
                ...
                className='flex-1'>
                <p className='mb-10 max-w-2xl font-Ovo'>jjjj</p>
                ...
                <motion.h4 
                    ...
                    className='my-6 text-gray-700 font-Ovo dark:text-white/80'>Skills and Tools</motion.h4>
                <motion.ul 
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
